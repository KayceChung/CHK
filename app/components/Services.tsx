  ...
  const services = [
    {
      ...
      features: [
        { en: 'Certified C1-C2 English proficiency', vi: 'Chứng chỉ tiếng Anh C1-C2' },
        { en: 'Real-time business dialogue translation', vi: 'Phiên dịch đối thoại kinh doanh real-time' },
        { en: 'Technical & commercial terminology expertise', vi: 'Chuyên môn thuật ngữ kỹ thuật & thương mại' },
        { en: 'Cross-cultural communication facilitation', vi: 'Hỗ trợ giao tiếp đa văn hóa' },
      ],
    },
    {
      icon: ShoppingCart,
      ...
      features: [
        { en: 'E-Commerce strategy & market analysis', vi: 'Chiến lược E-Commerce & phân tích thị trường' },
        { en: 'Platform setup & optimization', vi: 'Thiết lập & tối ưu nền tảng' },
        { en: 'Sales funnel & conversion optimization', vi: 'Tối ưu phễu bán hàng & chuyển đổi' },
        { en: 'Digital marketing integration', vi: 'Tích hợp marketing số' },
      ],
    },
    {
      icon: Workflow,
      ...
      features: [
        { en: 'No-code app development (AppSheet)', vi: 'Phát triển ứng dụng no-code (AppSheet)' },
        { en: 'Workflow automation & optimization', vi: 'Tự động hóa & t��i ưu quy trình' },
        { en: 'SQL database & data analysis', vi: 'Cơ sở dữ liệu SQL & phân tích dữ liệu' },
        { en: 'API integration & scripting', vi: 'Tích hợp API & scripting' },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => {
            ...
            const isVietnamese = t('nav.about') === 'Giới Thiệu';
              ...
              >
                ...
                <div className="h-full bg-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/30 hover:border-cyan-400/60 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/20 hover:-translate-y-2">
                  ...
                  <h3 className="text-2xl text-white mb-4 group-hover:text-cyan-400 transition-colors">
                    {isVietnamese ? service.titleVi : service.titleEn}
                  </h3>

                  {/* Description */}
                  <p className="text-gray-400 mb-6 leading-relaxed">
                    {isVietnamese ? service.descriptionVi : service.descriptionEn}
                  </p>
